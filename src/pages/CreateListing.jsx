            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12">
                ...
                <div className="p-8 bg-gray-50 shadow-lg rounded-xl">
                    ...
                    <div className="flex w-full md:gap-8 flex-col md:flex-row">
                        ...
                        <div className="flex flex-col md:w-1/2">
                            <label className="block text-gray-800 font-semibold mb-2">Furnished</label>
                            <select
                                name="furnished"
                                className="w-full p-3 mb-6 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out"
                                required
                    ...
                    <div className="flex w-full md:gap-8 gap-4 mb-5 flex-col md:flex-row">
                        <div className="flex flex-col md:w-1/2">
                            <div>
                                ...
                                />
                                <label className="text-gray-700 font-semibold">Parking Spot Available</label>
                            </div>
                        </div>
                        <div className="flex flex-col md:w-1/2">
                            <div>
                                ...
                                />
                                <label className="text-gray-700 font-semibold">Special Offer Available</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex w-full md:gap-8 flex-col md:flex-row">
                        <div className="flex flex-col md:w-1/2">
                            <label className="block text-gray-700 font-semibold mb-2">Beds</label>
                            <input
                                type="text"
                                name="bedrooms"
                        ...
                        <div className="flex flex-col md:w-1/2">
                            <label className="block text-gray-700 font-semibold mb-2">Baths</label>
                            <input
                                type="text"
                                name="bathrooms"
                    ...
                    <div className="flex w-full md:gap-8 flex-col md:flex-row">
                        <div className="flex flex-col md:w-1/2">
                            <label className="block text-gray-700 font-semibold mb-2">Regular Price <span className="text-gray-500 font-normal">($ / month)</span></label>
                            <input
                                type="text"
                                name="regularPrice"
                                placeholder="Price"
                        ...
                        {formData.offer && (
                            <div className="flex flex-col md:w-1/2">
                                <label className="block text-gray-700 font-semibold mb-2">Discount Price <span className="text-gray-500 font-normal">($ / month)</span></label>
                                <input
                                    type="text"
                                    name="discountPrice"
                                    placeholder="Price"
                ...
                <div className="p-8 bg-gray-50 shadow-lg rounded-xl">
                    <label className="block text-gray-700 font-semibold mb-4">Images: <span className="text-gray-500 font-normal">The first image will be cover (max 6)</span></label>
                    ...
                    <button disabled={loading || uploading} className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-4 rounded-xl font-semibold text-lg hover:scale-105 transition-transform duration-200 disabled:opacity-45">
